...
/**
 * Wraps a motor instance to provide corrected velocity counts and allow reversing without changing
 * the corresponding slot's motor direction
 */
public class Encoder {
  ...
  /**
   * Allows you to set the direction of the counts and velocity without modifying the motor's
   * direction state
   *
